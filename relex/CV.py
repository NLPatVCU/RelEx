...
def run_CNN_model (seg_train, embedding_path, embed_dim, cnn_model, write_predictions = False, write_No_rel = False, initial_predictions = None, final_predictions=None):
    """
    Call CNN models
