...
def convert(input_folder, ARG1_folder, ARGM_folder):
            ...
            for key in annotations['relations']:
                for label_rel, entity1, entity2 in [annotations['relations'][key]]:
                    if label_rel == 'ARG1':
                        ...
                        f1.write(str(key) + '\t' + str(new_label) + ' ' + 'Arg1:' + str(entity2) + ' ' + 'Arg2:' + str(
                            entity1) + '\n')
                        f1.close()
                        ...
                        annotations['relations'][key] = (new_label, entity1, entity2)
                        # print(new_label)
                        f2.write(str(key) + '\t' + str(new_label) + ' ' + 'Arg1:' + str(entity2) + ' ' + 'Arg2:' + str(
                            entity1) + '\n')
                        f2.close()