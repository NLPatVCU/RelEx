...
print("duplicates :", sum(i > 1 for i in duplicate_count))
...
# print(binary_Y)
# multilabel = np.sum(binary_Y, axis=1)
# # multilabel_count = np.where(np.sum(binary_Y, axis=1)==1, 0, np.sum(binary_Y, axis=1))
# print(multilabel)
# print("Total :", len(multilabel))
# multilabel_count = sum(i > 1 for i in multilabel)
# print("Multi-label count: ", multilabel_count)
