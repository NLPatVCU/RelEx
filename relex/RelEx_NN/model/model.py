...
class Model:
    ...
    def __init__(self, sentrain, labeltrain, sentest, labeltest, segment=True, test=False, multilabel=True, one_hot=False, common_words=10000, maxlen=100):
        ...
        print("test: "+str(test))
        print("multilabel: "+str(multilabel))
        print("common words: "+ str(common_words))
        print("maxlen: "+str(maxlen))
        print("labeltrain: "+labeltrain)
        print("sentrain:"+sentrain)

        #print("Current dir:"+os.getcwd())
        # read dataset from external files
        #print(path+"/sentence_train")
        train_data = read_from_file(sentrain)
        train_labels = read_from_file(labeltrain)
